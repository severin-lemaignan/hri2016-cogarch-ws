...
\begin{frame}{Highlights}
    ...
    \begin{itemize}
        \item {\Medium explicit}, {\Medium high-level semantics} (good for NLP!)
        \item appreciated by software engineers (loose coupling)
...
\begin{frame}{Cross-disciplinary ``Impedance Matching''}
    ...
    \uncover<2>{
    Other disciplines are mostly agnostic: cognitive psy., developmental psy.,...
    }

    \uncover<3>{
        Also relevant to the nature of {\Medium predictions} you want to
...
\begin{frame}{``High-level'' cognition for interaction}

    \begin{table}[]
        \begin{tabularx}{\linewidth}{lll}
            \toprule
            {\Medium Function} & {\Medium Symbolic}  & {\Medium Sub-symbolic}\\
            \midrule
            Conceptualization & Use Arial instead of Flama \tabularnewline
            & Math formula typeset in sans-serif \tabularnewline
